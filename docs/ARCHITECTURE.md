...
**SQLite Database**: `~/.unitmail/data/unitmail.db`
...
**2. Storage Layer**
- SQLite database with optional SQLCipher encryption
- Single-file storage for easy backup
...
**What Gets Backed Up**
- SQLite database (messages, contacts, config) - single file copy
- DKIM private keys
- PGP keys
- Configuration files
